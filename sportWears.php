...
<body>
    ...
    <div class="shopShoe">
        <img class="jewelry-image" src="./images/jersey11.jpg" alt=" a jewelry">
       <div>
      <h1 class="h1ShoeText">Gear Up for Action</h1>
      <p class="shoeText">
        Explore our dynamic collection of sportswear and fitness apparel designed to 
        elevate your performance and style. From breathable activewear to supportive 
        fitness gear, discover the perfect outfit for your active lifestyle. Dive into
         quality materials, innovative designs, and a range that empowers you to achieve
