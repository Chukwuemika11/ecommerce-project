...
<body>
 ...
 <!-- <div class="blogPages1"> -->
    ...
    <div class="blog-container">
        <img src="./images/shoe10.jpg" alt="Blog Image 1">
        <div class="content">
    ...
    <div class="blog-container">
        <img src="images/shoe1.jpg" alt="Blog Image 2">
        <div class="content">
            <h1>
    ...
    <div class="blog-container">
        <img src="images/shoe7.jpg" alt="Blog Image 3">
        <div class="content">
    ...
    <a href="./shoesBlog.php"><button class="circleNav">1</button></a>
    <a href="./shoesBlog2.php"><button class="circleNav">2</button></a>
    <a href="./shoesBlog3.php"><button class="circleNav">3</button></a>
    </div>
             <!-- footer -->
             <footer>
