...
<body>
 ...
 <!-- <div class="blogPages1"> -->
    ...
    <div class="blog-container">
        <img src="./images/jewelry2.jpg" alt="Blog Image 1">
        <div class="content">
    ...
    <div class="blog-container">
        <img src="images/jewelry12.jpg" alt="Blog Image 2">
        <div class="content">
            <h1>
    ...
    <div class="blog-container">
        <img src="images/jewelry11.jpg" alt="Blog Image 3">
        <div class="content">
    ...
    <a href="./jewelriesBlog.php"><button class="circleNav">1</button></a>
    <a href="./jewelriesBlog2.php"><button class="circleNav">2</button></a>
    <a href="./jewelriesBlog3.php"><button class="circleNav">3</button></a>
    </div>
             <!-- footer -->
             <footer>
