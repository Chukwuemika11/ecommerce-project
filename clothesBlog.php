...
<body>
 ...
 <a class="active" href="./clothesBlog.php"><button class="btn">fashion</button></a>
 ...
 <!-- <div class="blogPages1"> -->
    ...
    <div class="blog-container">
        <img src="./img/shirt 12.jpeg" alt="Blog Image 1">
        <div class="content">
    ...
    <div class="blog-container">
        <img src="img/shirt 15.jpg" alt="Blog Image 2">
        <div class="content">
            <h1>
    ...
    <div class="blog-container">
        <img src="img/shirt 16.jpg" alt="Blog Image 3">
        <div class="content">
    ...
    <a href="./clothesBlog.php"><button class="circleNav">1</button></a>
    <a href="./clothesBlog2.php"><button class="circleNav">2</button></a>
    <a href="./clothesBlog3.php"><button class="circleNav">3</button></a>
    </div>
             <!-- footer -->
             <footer>
