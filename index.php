            ...
            <div class="carousel-container">
               ...
               <div id="product1">
                <div class="pro">
                    ...
                    <button onclick="goToShirtPage()">Shop Now</button>
                </div>
            </div>
            ...
            <div class="carousel-container">
               ...
               <div id="product1">
                <div class="pro">
                    ...
                    <button onclick="goToJewelryPage()">Shop Now</button>
        ...
        <div class="carousel-container">
           ...
           <div id="product1">
            <div class="pro">
                ...
                <button onclick="goToFoodPage()">Shop Now</button>
            </div>
        </div>
        ...
        <div class="carousel-container">
           ...
           <div id="product1">
            <div class="pro">
                ...
                <button onclick="goToSportWearsPage()">Shop Now</button>
            </div>
        </div>
...
<!-- <div></div> -->
   ...
   <div id="culinary-delights" class="category">
    ...
    <div class="carousel-container">
       ...
       <div id="product1">
        <div class="pro">
            ...
            <button onclick="culiniaryDelightsPage()">Shop Now</button>
        </div>
    </div>
    ...
    <div class="carousel-container">
       ...
       <div id="product1">
        <div class="pro">
            ...
            <button onclick="drinksPage()">Shop Now</button>
        </div>
    </div>
    ...
    <div class="carousel-container">
       ...
       <div id="product1">
        <div class="pro">
            ...
            <button onclick="othersPage()">Shop Now</button>
        </div>
    </div>
                ...
                <div class="carousel-container">
                   ...
                   <div id="product1">
                    <div class="pro">
                        ...
                        <button onclick="newArrivalsPage()">Shop Now</button>
                    </div>
                </div>
                ...
                <div class="carousel-container">
                   ...
                   <div id="product1">
                    <div class="pro">
                        ...
                        <button onclick="backToSchoolDealsPage()">Shop Now</button>
                    </div>
                </div>
                    ...
                    <div class="carousel-container">
                       ...
                       <div id="product1">
                        <div class="pro">
                            ...
                            <button onclick="comingSoonPage()">Shop Now</button>
