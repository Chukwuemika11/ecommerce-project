...
<body>
 ...
 <!-- <div class="blogPages1"> -->
    ...
    <div class="blog-container">
        <img src="./images/comingsoon11.jpg" alt="Blog Image 1">
        <div class="content">
    ...
    <div class="blog-container">
        <img src="images/comingsoon12.jpg" alt="Blog Image 2">
        <div class="content">
            <h1>
    ...
    <div class="blog-container">
        <img src="images/comingsoon15.jpg" alt="Blog Image 3">
        <div class="content">
    ...
    <a href="./comingSoonBlog.php"><button class="circleNav">1</button></a>
    <a href="./comingSoonBlog2.php"><button class="circleNav">2</button></a>
    <a href="./comingSoonBlog3.php"><button class="circleNav">3</button></a>
    </div>
             <!-- footer -->
             <footer>
