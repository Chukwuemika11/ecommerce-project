          ...
          <ul id="navbar">
              ...
              <div class="sub-categories">
                ...
                <div>
                    ...
                    <a class="active" href="./comingSoon.php">comingSoon</a>
...
<body>
    ...
    <div class="shopShoe">
        <img class="jewelry-image" src="./images/comingsoon10.jpg" alt=" a jewelry">
       <div>
      <h1 class="h1ShoeText">Coming Soon: A Sneak Peek</h1>
      <p class="shoeText">
Get ready for something extraordinary! We're thrilled to share a sneak peek of what's coming soon
 to Zempaa. Anticipate the excitement as we prepare to unveil a collection 
that's carefully curated and designed to elevate your experience. Stay tuned for the big reveal!    
      </p>
</div>
          </div>
