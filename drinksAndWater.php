        ...
        <div>
          <ul id="navbar">
              ...
              <div class="sub-categories">
                ...
                <div>
                    <a class="drinkwa active" href="./drinksAndWater.php">drinks and water</a>
...
">newArrivals</a>
    ...
    <div class="shopShoe">
        <img class="jewelry-image" src="./images/drinks9.jpg" alt=" a jewelry">
       <div>
      <h1 class="h1ShoeText">Quench Your Thirst</h1>
      <p class="shoeText">
        Dive into our refreshing collection of drinks and hydrate with the purest waters.
         From tantalizing beverages to natural spring water, discover a world of refreshment 
         that will keep you energized and hydrated throughout the day.
         Immerse yourself in quality, taste, and the perfect drink for every mood.
      </p>
</div>
          </div>
