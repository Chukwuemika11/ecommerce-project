...
<body>
 ...
 <!-- <div class="blogPages1"> -->
    ...
    <div class="blog-container">
        <img src="./images/newarrivals6.jpg" alt="Blog Image 1">
        <div class="content">
    ...
    <div class="blog-container">
        <img src="images/newarrivals10.jpg" alt="Blog Image 2">
        <div class="content">
            <h1>
    ...
    <div class="blog-container">
        <img src="images/newarrivals11.jpg" alt="Blog Image 3">
        <div class="content">
    ...
    <a href="./newArrivalsBlog.php"><button class="circleNav">1</button></a>
    <a href="./newArrivalsBlog2.php"><button class="circleNav">2</button></a>
    <a href="./newArrivalsBlog3.php"><button class="circleNav">3</button></a>
    </div>
             <!-- footer -->
             <footer>
