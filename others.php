...
<body>
          ...
          <ul id="navbar">
              ...
              <div class="sub-categories">
                ...
                <div>
                    ...
                    <a class="active" href="./others.php">others</a>
    ...
    <div class="shopShoe">
        <img class="jewelry-image" src="./images/others2.jpg" alt=" a jewelry">
       <div>
      <h1 class="h1ShoeText">Discover the Extraordinary</h1>
      <p class="shoeText">
        Welcome to our one-stop destination for all things extraordinary.
         Dive into a world of endless possibilities, where each product is curated to bring joy, style, 
         and innovation to your life. From unique finds to everyday essentials,
          explore a diverse collection that caters to your every need.
      </p>
</div>
          </div>
