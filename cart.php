        ...
        <div>
          <ul id="navbar">
              ...
              <div class="sub-categories">
                ...
                <a class="cartLink shiftDown active" href="./cart.php" onclick="goToPage('cart')">Cart <span id="cartCountDesktop">0</span></a>
...
<!-- Add a class to the quantity span for easier targeting -->
<div id="cartPage">
    <h1 class="orderH1">Ordered items</h1>
    <div id="cartItems"><p></p></div>
    <p class="totalPrice">Total Price: ₦<span id="totalPrice">0.00</span></p>
    <button class="cart-button" onclick="deleteAllItems()">Delete All Items</button>
    <button class="cart-button" onclick="goToShopPage()">Go to Shopping</button>
    <button class="cart-button" onclick="checkout()">Checkout</button>
     ...
     <!-- <div id="cartPage">
        ...
        <button onclick="goToShop()">Go to Shopping</button>
      </div>
    </div> -->
