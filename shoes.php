...
<body>
        ...
        <div>
          <ul id="navbar">
              ...
              <div class="sub-categories">
                <div>
                    <a class="active" href="./shoes.php">Shoes</a>
 ...
 <div>
<h1 class="h1ShoeText">  Step Into Style</h1>
<p class="shoeText">
Welcome to our Shoes collection, where fashion meets comfort. 
Explore our carefully curated selection of footwear that combines the latest trends with quality craftsmanship. From casual kicks to elegant heels, 
find the perfect pair to elevate your style. Discover comfort, step by step.
</p>
</div>
    </div>
