          ...
          <ul id="navbar">
              ...
              <div class="sub-categories">
                ...
                <div>
                    ...
                    <a class="newArr active" href="./newArrivals.php">newArrivals</a>
                </div>
                    <!-- <div class="block"> -->
                    <!-- </div> -->
                </div>
...
<body>
    ...
    <div class="shopShoe">
        <img class="jewelry-image" src="./images/newarrivals5.jpg" alt=" a jewelry">
       <div>
      <h1 class="h1ShoeText">Just In: New Arrivals</h1>
      <p class="shoeText">
        Be the first to explore our latest arrivals, carefully curated to bring you the freshest
         and most exciting products. From cutting-edge styles to innovative designs, discover 
         what's trending and elevate your lifestyle with our new arrivals. 
         Dive into a world of possibilities and stay ahead of the curve.        
      </p>
</div>
          </div>
