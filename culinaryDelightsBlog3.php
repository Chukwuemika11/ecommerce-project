          ...
          <ul id="navbar">
              ...
              <div class="sub-categories">
                ...
                <div>
                    ...
                    <a class="culinaryd class" href="./culinaryDelights.php">culiniaryDelights</a>
...
">newArrivals</a>
 ...
 <!-- <div class="blogPages1"> -->
    ...
    <div class="blog-container">
        <img src="./images/culiniary10.jpg" alt="Blog Image 1">
        <div class="content">
    ...
    <div class="blog-container">
        <img src="images/culiniary3.jpg" alt="Blog Image 2">
        <div class="content">
            <h1>
    ...
    <div class="blog-container">
        <img src="images/culiniary2.jpg" alt="Blog Image 3">
        <div class="content">
