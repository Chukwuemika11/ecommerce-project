          ...
          <ul id="navbar">
              ...
              <div class="sub-categories">
                ...
                <div>
                    ...
                    <a class="culinaryd active" href="./culinaryDelights.php">culiniaryDelights</a>
...
<body>
    ...
    <div class="shopShoe">
        <img class="jewelry-image" src="./images/culiniary2.jpg" alt=" a jewelry">
       <div>
      <h1 class="h1ShoeText">Culinary Treasures Await</h1>
      <p class="shoeText">
        Embark on a gastronomic adventure with our exquisite collection of culinary delights.
         From gourmet ingredients to artisanal treats, discover the finest flavors that will 
         elevate your culinary creations. Immerse yourself in quality, taste, and a world of 
         culinary excellence.
              </p>
</div>
          </div>
